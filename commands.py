...
fn_table={ 9:lambda x:x.push(sys.stdin.read(1)),
          ...
          42:star_fn,
          43:plus_fn,
          44:lambda x:x.push((lambda y:list(y) if type(y) is TupleType else y)(input())),
          ...
          73:if_fn,
          74:j_fn,
          75:lambda x:x.push(math.ceil(x.pop())),
          76:lambda x:x.push(math.floor(x.pop())),
          77:map_fn,
          ...
          138:lambda x:x.push(repr(x.pop())),
          ...
          161:index_fn,
          162:cond_quit_fn,
          164:lambda x:x.push(map(list,enumerate(x.pop()))),
